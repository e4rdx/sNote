...
/*
By: https://gist.github.com/hzqtc/7940858
 */
public class FlowLayout extends ViewGroup {
    ...
    private void init() {
        paddingHorizontal = 10;//getResources().getDimensionPixelSize(R.dimen.flowlayout_horizontal_padding);
        paddingVertical = 10;//getResources().getDimensionPixelSize(R.dimen.flowlayout_vertical_padding);
    }
